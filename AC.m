...
%% simulare
Tz=1000
Hc1=tf([Tz 1], [a*Tz+b 1]);
Ho1=feedback(series(Hvths,Hc1),1)
zpk(Ho1)
figure, 
subplot(1,2,1), step(Ho1)
title('Regulator cu întârziere de fază');
Ho1=feedback(series(Hvths,1/a),1);
subplot(1,2,2), step(Ho1)
...
Ho1=feedback(series(H,0.045),1)
figure, step(Ho1,Ho1.NominalValue);
title("Sistem B-proportional")

Ho1=feedback(0.045,H);
figure, step(100*Ho1)
title('Intrare motor [V]');
